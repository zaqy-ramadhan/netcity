!(function (e, t) {
    ...
    function T(e, t, i) {
        ...
        else if ((C(t) && ((i = t), (t = !1)), E(t) && t in window))
            C(i) && i();
        else {
            var n;
            if (-1 !== e.indexOf(".css")) {
                            ...
                            if (this.slide.classList.contains("zoomed"))
                                ...
                                -1 !==
                                    ...
                                    : (e.preventDefault(),
                                      (e.target === this.el ||
                                          ("img" !== t &&
                                              v(e.target, ".gslide-inline"))) &&
                                          ((this.active = !0),
                                          this.el.classList.add("dragging"),
                                          (this.dragContainer = v(
                                              e.target,
                                              ".ginner-container"
                                          ))));
                            }
    ...
    function R(e, t, i) {
        ...
        d(s, "gvideo-container"),
            o.insertBefore(
                x('<div class="gvideo-wrapper"></div>'),
                o.firstChild
            );
        ...
        "file" == c && (c = "http"),
            ...
            T(this.settings.plyr.js, "Plyr", function () {
                ...
                if (null !== h.match(/\.(mp4|ogg|webm|mov)$/)) {
                    u = "local";
                    var o = '<video id="' + l + '" ';
                    (o += 'style="background:#000; max-width: '.concat(
                        t.width,
                        ';" '
                    )),
                        (o += 'preload="metadata" '),
                ...
                var b = M(n.settings.plyr, "config")
    ...
    function Z(e, t, i) {
        ...
        if (
            r &&
            (E(r) &&
                (n = x('<div class="ginlined-content">'.concat(r, "</div>"))),
            A(r))
        ) {
                ...
                n(e, [
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                this.setSize(n, t), (this.slideConfig = n), n
                            );
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                "" == s.title && "" == s.description
                                    ? u &&
                                      u.parentNode.parentNode.removeChild(
                                          u.parentNode
                                      )
                                    : (h && "" !== s.title
                                          ? ((h.id = f),
